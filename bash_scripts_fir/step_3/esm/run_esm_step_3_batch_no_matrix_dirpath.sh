...
cat esm_step_3_batch_no_matrix_dirpath.sh > /home/schen123/scratch/kinases/sbc806/RumHKNet/bash_scripts_fir/step_3/esm/output/both_step_3_batch_no_matrix_dirpath_$SLURM_JOB_ID.txt
