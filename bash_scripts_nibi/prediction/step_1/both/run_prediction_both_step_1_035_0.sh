...
#SBATCH --output=output/prediction_both_step_1_035_0_%j.out
#SBATCH --err=output/prediction_both_step_1_035_0_%j.err
...
./prediction_scripts/step_1/both/prediction_both_step_1.sh 0.35 035 train_0
