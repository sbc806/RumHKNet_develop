...
#SBATCH --gpus-per-node=nvidia_h100_80gb_hbm3.40gb:1
#SBATCH --mem=32G
#SBATCH --time=1-0
...
./prediction_scripts/step_1/both/prediction_both_step_1.sh 0.3 03 step_1_non_kinases_preprocessed_dev 3432 _v2
