...
#SBATCH --err=output/prediction_both_step_1_train_0_100000_v3_%j.err
...
./prediction_scripts/step_1/both/prediction_both_step_1_v3.sh 0.3 03 train_0_100000_new 3432 200 _v3
