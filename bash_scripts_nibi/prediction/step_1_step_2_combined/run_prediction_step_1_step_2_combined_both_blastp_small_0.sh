...
./prediction_scripts/step_1_step_2_combined/both/prediction_both_step_1_step_2_combined_v3.sh 0.2 02 histidine_blastp_ko_no_rumhknet_small_0 1500 50 _v3
