...
#SBATCH --mem=32G
#SBATCH --time=1-0
#SBATCH --job-name=prediction-both-step-1-step-2-combined-blastp-small-1-v3
#SBATCH --output=output/prediction_both_step_1_step_2_combined_blastp_small_1_v3_%j.out
#SBATCH --err=output/prediction_both_step_1_step_2_combined_blastp_small_1_v3_%j.err
