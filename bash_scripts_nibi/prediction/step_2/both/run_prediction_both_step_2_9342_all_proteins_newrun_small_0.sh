...
#SBATCH --mem=32G
#SBATCH --time=1-0
#SBATCH --job-name=prediction-both-step-2-9342-all-proteins-newrun-small-0-v3
...
./prediction_scripts/step_2/both/prediction_both_step_2_v3.sh 0.2 02 9342_all_proteins_newrun_step_1_kinase_small 1500 50 _v3
