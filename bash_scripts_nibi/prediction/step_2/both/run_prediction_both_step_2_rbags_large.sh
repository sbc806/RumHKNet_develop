...
#SBATCH --mem=32G
#SBATCH --time=12:0:0
#SBATCH --job-name=prediction-both-step-2-sequences-large-02
#SBATCH --output=output/prediction_both_step_2_sequences_large_02_%j.out
#SBATCH --err=output/prediction_both_step_2_sequences_large_02_%j.err
