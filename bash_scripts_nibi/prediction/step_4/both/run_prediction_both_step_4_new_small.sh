...
#SBATCH --err=output/prediction_both_step_4_new-small_v4_%j.err
...
./prediction_scripts/step_3/both/prediction_both_step_4_v4.sh 0.3 03 newrun_seqs_small_histidine_kinase_batch 1500 50 _v4
