...
#SBATCH --mem=32G
#SBATCH --time=3-0
#SBATCH --job-name=prediction-both-step-1-2026-04-22-small-4-v3
#SBATCH --output=output/prediction_both_step_1_2026_04_22_small_4_v3_%j.out
#SBATCH --err=output/prediction_both_step_1_2026_04_22_small_4_v3_%j.err
