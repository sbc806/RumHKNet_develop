...
#SBATCH --err=output/prediction_both_step_1_small_18_v3_%j.err
...
./prediction_scripts/step_1/both/prediction_both_step_1_v3_rorqual.sh 0.3 03 clustered_rep_seq95_small_18 1500 50 _v3
