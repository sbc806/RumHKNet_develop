...
#SBATCH --mem=200G
#SBATCH --time=7-0
#SBATCH --job-name=both-step-3-class-no-matrix-dirpath
#SBATCH --output=output/both_step_3_class_no_matrix_dirpath_%j.out
#SBATCH --err=output/both_step_3_class_no_matrix_dirpath_%j.err
