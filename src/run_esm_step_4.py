...
def main():
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        model = model_class.from_pretrained(os.path.join(model_trained_dir_path,"extra_p_133_class_v3_batch/protein/multi_class/lucaprot/matrix/20251209200204/checkpoint-100221"), args=args)
        model.to(args.device)
