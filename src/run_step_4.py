...
def main():
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        log_fp.write("checkpoint path: %s\n" % checkpoint)
        # model = model_class.from_pretrained(checkpoint, args=args)
        model_trained_dir_path = "/home/schen123/links/projects/def-guanuofa/schen123/kinases/sbc806/RumHKNet_develop/models_both_step_3_batch_1/models"
        model = model_class.from_pretrained(os.path.join(model_trained_dir_path,"extra_p_133_class_v3_batch/protein/multi_class/lucaprot/seq_matrix/20251209201835/checkpoint-100221"), args=args)
        model.to(args.device)
