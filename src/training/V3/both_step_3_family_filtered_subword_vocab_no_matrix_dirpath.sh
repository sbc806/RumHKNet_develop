...
# for dataset
DATASET_NAME="step_3_family_filtered"
...
buffer_size=4096
## tokenizer dir
tokenizer_dir=step_3_family_filtered
## positive weight
...
python -u run.py \
  ...
  --output_dir ../models_both_step_3_family_filtered_subword_vocab_no_matrix_dirpath/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$MODEL_TYPE/$INPUT_TYPE/$time_str \
